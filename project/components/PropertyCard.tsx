            ...
            <div className="p-4">
                ...
                >
                    {property.rates.nightly && (
                        <p className='flex items-center'><FaMoneyBill className='inline mr-2' />Nightly</p>
                    )}

                    {property.rates.weekly && (
                        <p className='flex items-center'><FaMoneyBill className='inline mr-2' />Weekly</p>
                    )}

                    {property.rates.monthly && (
                        <p className='flex items-center'><FaMoneyBill className='inline mr-2' />Monthly</p>
                    )}
                </div>
